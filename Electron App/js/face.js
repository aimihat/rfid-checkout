        ...
        function processVideo() {
            try {
                ...
                if (facesInCircle == 1) {
                    ...
                    circle.style.border = "4px double rgba(255, 143, 57, 0.9)";
                    if (Math.abs(finalFace.x-previousX)<10 && Math.abs(finalFace.y-previousY)<10){
    ...
    $.ajax({
        ...
        for (i = 0; i < customerListObject.length; i++) {
            if (!data[0].candidates[0]) {
                //create small canvas for display
